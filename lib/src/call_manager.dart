...
class CallManager {
  ...
  Future<void> inviteUser(List<String> userIdList) async {
    ...
    var createOfflinePushInfo = OfflinePushInfoConfig.createOfflinePushInfo();
    createOfflinePushInfo.androidFCMChannelID = "sapa_default_call";
    createOfflinePushInfo.iOSPushType = TUICallIOSOfflinePushType.VoIP;
    params.offlinePushInfo = createOfflinePushInfo;
